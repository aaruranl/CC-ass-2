    ...
    <div class="container mt-5">
        <div class="row mb-5">
            <div class="col-md-12 text-center">
                <h3><strong>Book Management</strong></h3>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h5 style="float: left;"><strong>All Book Details</strong></h5>
                        <button class="btn btn-sm btn-primary" style="float: right;" data-toggle="modal" data-target="#addStudentModal">Add New Book</button>
                    </div>
                    <div class="card-body">
                ...
                <div class="modal-body">
                    ...
                    <form wire:submit.prevent="storeStudentData">
                        <div class="form-group row">
                            <label for="student_id" class="col-3">Book ID</label>
                            <div class="col-9">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-3">Book Name</label>
                            <div class="col-9">
                        ...
                        <div class="form-group row">
                            <label for="phone" class="col-3">Book Cost</label>
                            <div class="col-9">
                ...
                <div class="modal-body">
                    ...
                    <form wire:submit.prevent="editStudentData">
                        ...
                        <div class="form-group row">
                            <label for="" class="col-3"></label>
                            <div class="col-9">
                                <button type="submit" class="btn btn-sm btn-primary">Edit Books</button>
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body pt-4 pb-4">
                    <h6>Are you sure? You want to delete this Book data!</h6>
                </div>
